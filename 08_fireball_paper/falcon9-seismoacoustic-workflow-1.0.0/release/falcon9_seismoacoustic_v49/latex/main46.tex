...
\begin{figure*}[!tbp]
  \centering
  \includegraphics[width=0.96\textwidth]{figures/fig01_slc40_bchh_location.pdf}
...
\begin{figure*}[!tbp]
  ...
  waveforms for the 51 events in the high-quality planar class. The pressure
  trace is the median of DD1, DD2, and DD3 after DD1 and DD3 were shifted by
  their predicted differential acoustic travel times to the DD2 reference.
  DHZ is unshifted at the seismometer. Its approximately 11.6-m longer
  source--receiver path corresponds to an expected approximately 0.033-s later
  local acoustic arrival than at DD2; this is not a fitted pressure--ground
  delay. Pale curves are individual events, the dark curve is the pointwise
  median, and shading spans the 16th--84th percentiles.}
...
uncertainties not included in that percentage. Bracketing-launch calibration
checks remain outstanding. These limitations preserve the relative timing,
