...
def make_figure1(
    ...
    set_equal_ground_aspect(ax)
    # Avoid automatic zoom 20 and the volunteer-run OSM tile endpoint. At
    # this metre-scale extent the basemap is contextual; the surveyed sensor
    # positions and connecting geometry are the scientific information.
    add_basemap(ax, provider="voyager", alpha=0.68, zoom=19)
    ax.set_xlim(lonlim)
    ax.set_ylim(latlim)
