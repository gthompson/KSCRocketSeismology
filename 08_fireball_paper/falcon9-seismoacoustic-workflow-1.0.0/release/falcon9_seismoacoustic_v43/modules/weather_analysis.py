...
def calculate_acoustic_summary(
    ...
    *,
    ...
    sound_speed_kwargs: dict | None = None,
) -> dict:
    ...
    return {
        ...
        "sound_speed_model": getattr(compute_speed_of_sound, "__name__", "custom"),
        "sound_speed_parameters": dict(sound_speed_kwargs or {}),
