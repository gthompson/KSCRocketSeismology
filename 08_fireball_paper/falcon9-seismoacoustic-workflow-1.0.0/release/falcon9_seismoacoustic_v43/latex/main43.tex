...
complementary rather than independent. Bootstrap ranges and permutation
thresholds are conditional and pointwise.
...
\begin{figure*}[!tbp]
  ...
  magnitude-squared coherence. Agreement between complementary event-window and continuous estimates
  supports repeatable site-response bands. Shading shows conditional pointwise
  bootstrap ranges; event resampling retains separate catalogue records despite
  possible overlap. Dotted curves are pointwise permutation-derived empirical
  coherence thresholds. Neither represents total physical uncertainty or a
  simultaneous-band significance test.}
  \label{fig:transfer}
\end{figure*}
