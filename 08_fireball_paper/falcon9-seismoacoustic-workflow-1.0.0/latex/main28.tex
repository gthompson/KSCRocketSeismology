...
\begin{figure*}[!tbp]
  \centering
  \IfFileExists{../data/outputs/040_validate_event_catalogue_with_array_processing/figures/catalogue_bartlett_summary_utc_phase.pdf}{%
    \includegraphics[width=0.98\textwidth]{catalogue_bartlett_summary_utc_phase.pdf}%
  }{%
    \pendingfigure{Event-centred InfraPy figure showing back azimuth,
    apparent trace velocity, and Bartlett $F$ through UTC.}%
  }
  \caption{Event-centred InfraPy Bartlett results through the 153-transient
  sequence: (a) back azimuth, (b) apparent trace velocity, and (c) $F$
  statistic. Dashed or dotted reference lines show the geometric SLC-40 back
  azimuth, meteorological effective speed, and 99.5th-percentile background
  threshold. Blue points exceed that threshold, grey points do not, red
  crosses identify search-grid-edge solutions, and pale shading marks the
  four catalogue phases. Point size increases with $F$.}
