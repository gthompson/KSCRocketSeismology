%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Seismica submission manuscript -- shortened main paper, version 33
% Supporting detail and diagnostic figures are in supplement33.tex.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
interpreted signals with selected visual states. The frames illustrate the
developed visual sequence and are not additional source-time picks.
...
\begin{figure*}[!tbp]
  \centering
  \IfFileExists{../data/outputs/140_search_for_direct_seismic_waves/upper_stage_onset_and_polarization.pdf}{
    \includegraphics[width=0.98\textwidth]{upper_stage_onset_and_polarization.pdf}
  }{%
    \pendingfigure{Focused causal-onset and amplitude-gated polarization
    composite showing the 1.7--2.0-s interval and predicted 4.05-s airwave.
    Do not substitute the sequence-wide DOP/ellipticity figure.}%
  }
  \caption{Focused search for ground motion preceding the predicted upper-stage
ground-coupled airwave. Left panels show causal trailing three-component RMS
amplitude in four frequency bands, expressed relative to robust pre-event
noise; dash-dotted lines mark the median causal threshold-crossing times.
Right panels show amplitude-gated rectilinearity, degree of polarization, and
radiality, with shaded intervals representing the full timing ambiguity of the
trailing polarization windows. If associated with the upper-stage failure, the
repeatable 1.7--2.0-s low-frequency onset corresponds to a path-averaged
apparent velocity of 0.71--0.84~km~s$^{-1}$. The analysis interval ends before
the principal explosion and the predicted 4.046-s airwave, and the
single-station observations do not support a unique phase assignment.}
