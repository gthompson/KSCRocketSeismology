...
times and a 2--20-Hz band. An empirical detection threshold was defined as the
99.5th percentile of the results from 153 pre-event background windows,
corresponding to $F=3.02$. A separate continuous scan, performed without using
catalogue times to position the analysis windows, tested catalogue recovery
and searched for additional coherent activity.
