%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Seismica submission manuscript -- shortened main paper, version 34
% Supporting detail and diagnostic figures are in supplement34.tex.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\makeseistitle{
  ...
  reconstructed its chronology, manually screened a continuous 48-h record
  for conspicuous multichannel impulsive precursors, and measured source
  direction, propagation, pressure, ground motion, and acoustic--seismic
  coupling. The catalogue
  ...
  explosions. No conspicuous coherent impulsive precursor attributable to the
  accident was detected. The
  principal explosion occurred 3.60~s after the initial upper-stage event and
  produced median positive and peak-to-peak pressures of 1.39 and 1.55~kPa.
  Within the processed infraBSU passband (approximately 0.05--80~Hz), its
  median positive-peak sound pressure level was 156.8~dB re 20~$\mu$Pa and
  its median hemispherical radiated acoustic-energy estimate was
  $2.20\times10^9$~J (DD1--DD3 range $1.93$--$2.51\times10^9$~J).
  High-quality array solutions pointed toward the launch complex and gave a
  coherence-weighted apparent velocity of 352.0~m~s$^{-1}$, consistent with the
  meteorological prediction of 351.0~m~s$^{-1}$. Among 46 well-measured
  catalogue entries, pressure and three-component peak ground velocity were nearly
...
Trillium Compact Posthole--Centaur chain. Pressure-channel factors were
estimated empirically from approximately 10--20 repeated door-slam comparisons
at USF and KSC, without first dividing out a nominal infraBSU response.
Relative responses were averaged across tests and historically scaled by
treating the principal cluster among 25 infraBSU sensors as having the nominal
datasheet sensitivity of 18.4~counts~Pa$^{-1}$. The adopted factors are listed
in Table~\ref{tab:instrument_calibration}. The approximately $\pm20\%$ pressure
...
factors from repeated relative tests anchored to the nominal 18.4
counts~Pa$^{-1}$ cluster response.}
...
upper-stage signal was manually scanned in Antelope \texttt{dbpick}. All three
pressure and all three seismic channels were viewed together. The analyst
marked conspicuous impulsive signals readily visible across the compact array;
isolated local disturbances, including possible vehicle passages, occurred
elsewhere but were not treated as accident-related events. No comparable
multichannel impulse occurred close to the failure onset.

The resulting channel picks were associated into events with a short-window
MATLAB/GISMO script \citep{brtt_antelope,thompson_gismo_2017}. Pressure picks
were mapped to the canonical DD1--DD3
geometry and associated after differential travel-time reduction. A 0.040-s
coincidence window was selected as the smallest value on a stable
association-count plateau; a retained catalogue entry required picks on at
least two pressure channels. Because candidate impulses were already isolated
and visually evident, association formalized their grouping rather than
recovering marginal signals. Candidate waveforms were subsequently reviewed
for signal-to-noise ratio (SNR), correlation, and a coherent counterpart on the
remaining channel. The catalogue records accepted multichannel pressure
transients, not independently verified physical explosions.
...
an energy-unit conversion rather than a blast-yield estimate. Overlapping
catalogue windows were not summed as independent events. Efficiency-dependent
total-energy scenarios are confined to the Supplementary Material.
...
upper-stage source time was 13:07:11.91~UTC. The principal explosion followed 3.601~s
...
Principal explosion & 13:07:15.51 & 1390 & $-160$ & 1550 & 156.9 & $3.57\times10^{-3}$ \\
...
so it was not a high-speed outlier within the high-quality planar class. An
...
\begin{figure*}[!tbp]
  ...
  measurement-quality catalogue entries. The solid line is the log--log regression,
...
extrapolation, are provided in the Supplementary Material
(Figure~
ef{fig:supp_weak_shock}).
...
$2.20\times10^9$~J (DD1--DD3 range $1.93$--$2.51\times10^9$~J). These are
