%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Seismica submission manuscript -- shortened main paper, version 36
% Supporting detail and diagnostic figures are in supplement36.tex.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\makeseistitle{
  ...
  26~min. No conspicuous coherent impulsive precursor attributable to the
  accident was detected. The principal explosion followed the initial
  upper-stage event by about 3.6~s and produced median positive and
  peak-to-peak pressures of about 1.4 and 1.6~kPa. Its positive-peak sound
  ...
  was examined on all six channels. No conspicuous coherent impulsive signal
  attributable to the accident was found before the failure.
...
Trillium Compact Posthole--Centaur chain. One motivation for the KSC
deployment was to improve calibration of infraBSU sensors used during the
2015 Sakurajima campaign. The later published Sakurajima analysis applied a
common nominal manufacturer sensitivity of 18.4~counts~Pa$^{-1}$ to all six
infraBSUs \citep{smith_sakurajima_2020}, whereas contemporaneous field
calibration work had already raised concerns about substantial unit-to-unit
departures from that nominal value. Earlier close-spaced ``huddle'' tests at
USF, including repeated door-slam comparisons, were useful for estimating
relative sensor responses, while controlled sinusoidal tests provided an
absolute reference. Such laboratory tests are affected by room acoustics and
source--receiver position, however, so a relatively distant free-field source
such as a rocket provides a cleaner intersensor comparison because essentially
the same wavefield crosses the compact array. The historical pressure-channel
factors used here were estimated from approximately 10--20 repeated relative
tests and scaled by treating the principal cluster among 25 infraBSU sensors
as having the nominal datasheet sensitivity of 18.4~counts~Pa$^{-1}$.
Importantly, the November~2016 forensic report independently documents BCHH
lift-test sensitivities of 0.1234, 1.45, and 0.100~Pa~count$^{-1}$ for
DD1--DD3, equivalent to 8.10, 0.690, and 10.0~counts~Pa$^{-1}$,
respectively \citep{thompson_mcnutt_fireball_2016}. The adopted factors are listed in
Table~\ref{tab:instrument_calibration}. The approximately $\pm20\%$ pressure
uncertainty is an empirical estimate based on test-to-test variability, not a
laboratory-traceable absolute-calibration uncertainty. The specific infraBSU
sizes and capillary assemblies deployed on DD1--DD3 require confirmation;
these can affect sensitivity and frequency response. Manual arrival uncertainty
was approximately 0.01~s for the clearest impulses and greater for weak,
emergent, or overlapping signals.
...
upper-stage signal was manually scanned by the lead author (GT) in Antelope version~5.6
\texttt{dbpick} \citep{brtt_antelope}. All three pressure and all three seismic
...
accident-related events. No comparable multichannel impulse occurred close to
the failure onset.
...
No conspicuous coherent multichannel impulsive precursor attributable to the
accident was identified during the 37~h before the first signal. This visual
screen excludes only impulses comparable to the accepted array-wide events
...
seismic energy. The prolonged post-Phase-I signal contributes sustained
ground motion between the impulsive activity clusters. These diagnostics
support the descriptive phase boundaries while also showing appreciable
signal outside the short catalogue-event windows.
...
negative, and peak-to-peak pressures were +1.39~kPa, $-0.16$~kPa, and
1.55~kPa, and vector PGV was
...
\begin{figure*}[!tbp]
  ...
  99.5th-percentile Bartlett background threshold. In panel (c), larger $F$
...
A central forensic result is what was \emph{not} observed: no conspicuous
coherent impulsive precursor attributable to the accident was found before
the upper-stage failure. The same negative result was documented in the
...
This question motivated extending the continuous six-channel review to 37~h
...
have preceded it by only seconds. The negative result therefore argues against
...
The close-range array then records an abrupt upper-stage onset, a principal
explosion about 3.6~s later, two payload-associated signals, and continued
...
Several observations are compatible with nonlinear propagation of the
principal blast, but none alone demonstrates that it remained substantially
supersonic at 1.4~km. Its pressure waveform has a rapid compression followed by
a longer rarefaction, qualitatively Friedlander-like rather than a symmetric
N-wave. The independent Bartlett solution is on the high side of the catalogue,
and reducing BCHH arrivals with a fixed 351~m~s$^{-1}$ can place the inferred
source time slightly earlier than a video-constrained onset would suggest. A
faster early wavefront would produce exactly that sign of timing offset.
However, the preferred high-quality time-domain array solution for the same
event is 352.5~m~s$^{-1}$ and is essentially typical of the high-quality class.
This cautious receiver-side interpretation is consistent with the 2017 AGU
presentation, which concluded that the principal explosion was not unusually
fast across the array and found no evidence for a shock wave at BCHH, while
still considering shock-wave evolution closer to the source
...
pressure-dependent results, and the relative factors have not yet been
independently re-estimated from the free-field accident events. The regression
...
propagation, and coupling analysis. No conspicuous coherent impulsive precursor
attributable to the accident was found in the preceding 37~h of a gap-free six-channel
review. The principal explosion followed
...
$2.2\times10^9$~J (DD1--DD3 range $1.9$--$2.5\times10^9$~J). These are
